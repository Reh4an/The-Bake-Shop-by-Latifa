...
const menuItems = [
    ...
    { id: 42, name: "Pineapple Paradise", category: "Creamy Cakes", desc: "Tropical goodness loaded with fresh pineapple chunks and smooth whipped cream.", weight: "1/2 kg", price: 650, image: "assets/pineapple cake.jpeg", tags: ["Fresh Fruit", "Signature"],
      hasOptions: true, customDecorNote: true, options: [{ name: "1/2 kg", price: 650 }, { name: "1kg", price: 1200 }] },
    { id: 44, name: "Mango Delight", category: "Creamy Cakes", desc: "A rich fusion of classic Indian mangoes, whipped cream and cake.", weight: "1/2 kg", price: 800, image: "assets/mango cake.jpeg", tags: ["Signature", "Seasonal"],
      hasOptions: true, customDecorNote: true, options: [{ name: "1/2 kg", price: 800 }, { name: "1kg", price: 1500 }] },
    ...
    { id: 50, name: "Mango Sunshine Mousse", category: "Brownies & Mousse", desc: "Seasonal favorite made with fresh Alphonso mangoes.", weight: "Per cup", price: 60, image: "assets/Mango mousse.png", tags: ["Signature", "Fresh Fruit", "Seasonal"] },
    ...
    // Pastries
    { id: 101, name: "Bite Sized Chocolate Pastry", category: "Pastries", desc: "Delicious bite-sized chocolate pastry.", weight: "Options Available", price: 40, image: "assets/bite_sized_chocolate_pastry_1789193380398.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 40 }, { name: "Box of 10", price: 350 }] },
    { id: 102, name: "Bite Sized Dutch Chocolate Pastry", category: "Pastries", desc: "Rich bite-sized Dutch chocolate pastry.", weight: "Options Available", price: 50, image: "assets/bite_sized_dutch_chocolate_pastry_1789193412718.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 50 }, { name: "Box of 10", price: 450 }] },
    { id: 103, name: "Bite Sized Strawberry Pastry", category: "Pastries", desc: "Sweet bite-sized strawberry pastry.", weight: "Options Available", price: 45, image: "assets/bite_sized_strawberry_pastry_1789193474808.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 45 }, { name: "Box of 10", price: 400 }] },
    { id: 104, name: "Bite Sized Pineapple Pastry", category: "Pastries", desc: "Tropical bite-sized pineapple pastry.", weight: "Options Available", price: 40, image: "assets/bite_sized_pineapple_pastry_1789193489288.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 40 }, { name: "Box of 10", price: 350 }] },
    { id: 105, name: "Bite Sized Mango Pastry", category: "Pastries", desc: "Seasonal bite-sized mango pastry.", weight: "Options Available", price: 45, image: "assets/bite_sized_mango_pastry_1789193504478.jpg", tags: ["Seasonal"], hasOptions: true, options: [{ name: "1 Piece", price: 45 }, { name: "Box of 10", price: 400 }] },
    
    { id: 106, name: "Regular Chocolate Pastry", category: "Pastries", desc: "Classic rectangular chocolate pastry.", weight: "Options Available", price: 60, image: "assets/regular_chocolate_pastry_1789193943459.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 60 }, { name: "Box of 4", price: 220 }] },
    { id: 107, name: "Regular Dutch Chocolate Pastry", category: "Pastries", desc: "Classic rectangular Dutch chocolate pastry.", weight: "Options Available", price: 70, image: "assets/regular_dutch_chocolate_pastry_1789223384453.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 70 }, { name: "Box of 4", price: 250 }] },
    { id: 108, name: "Regular Red Velvet Buttercream Pastry", category: "Pastries", desc: "Classic red velvet with buttercream.", weight: "Options Available", price: 60, image: "assets/regular_red_velvet_buttercream_1789223396014.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 60 }, { name: "Box of 4", price: 220 }] },
    { id: 109, name: "Regular Red Velvet Cream Cheese Pastry", category: "Pastries", desc: "Classic red velvet with cream cheese.", weight: "Options Available", price: 70, image: "assets/regular_red_velvet_creamcheese_1789223408444.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 70 }, { name: "Box of 4", price: 250 }] },
    { id: 110, name: "Regular Strawberry Pastry", category: "Pastries", desc: "Classic rectangular strawberry pastry.", weight: "Options Available", price: 60, image: "assets/regular_strawberry_pastry_1789223425352.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 60 }, { name: "Box of 4", price: 220 }] },
    { id: 111, name: "Regular Pineapple Pastry", category: "Pastries", desc: "Classic rectangular pineapple pastry.", weight: "Options Available", price: 60, image: "assets/regular_pineapple_pastry.jpg", tags: [], hasOptions: true, options: [{ name: "1 Piece", price: 60 }, { name: "Box of 4", price: 220 }] },
    { id: 112, name: "Regular Mango Pastry", category: "Pastries", desc: "Classic rectangular mango pastry.", weight: "Options Available", price: 70, image: "assets/regular_mango_pastry_1789223440334.jpg", tags: ["Seasonal"], hasOptions: true, options: [{ name: "1 Piece", price: 70 }, { name: "Box of 4", price: 250 }] },

    { id: 113, name: "Premium Chocolate Pastry", category: "Pastries", desc: "Premium triangular chocolate pastry.", weight: "Options Available", price: 80, image: "assets/premium_chocolate_pastry_1789192747692.jpg", tags: ["Premium"], hasOptions: true, options: [{ name: "1 Piece", price: 80 }, { name: "Box of 4", price: 300 }] },
    { id: 114, name: "Premium Dutch Chocolate Pastry", category: "Pastries", desc: "Premium triangular Dutch chocolate pastry.", weight: "Options Available", price: 85, image: "assets/premium_dutch_chocolate_pastry_1789192760469.jpg", tags: ["Premium"], hasOptions: true, options: [{ name: "1 Piece", price: 85 }, { name: "Box of 4", price: 300 }] },
    { id: 115, name: "Premium Red Velvet Buttercream Pastry", category: "Pastries", desc: "Premium red velvet with buttercream.", weight: "Options Available", price: 85, image: "assets/premium_red_velvet_buttercream_1789192776486.jpg", tags: ["Premium"], hasOptions: true, options: [{ name: "1 Piece", price: 85 }, { name: "Box of 4", price: 300 }] },
    { id: 116, name: "Premium Red Velvet Cream Cheese Pastry", category: "Pastries", desc: "Premium red velvet with cream cheese.", weight: "Options Available", price: 90, image: "assets/premium_red_velvet_creamcheese_1789192790872.jpg", tags: ["Premium"], hasOptions: true, options: [{ name: "1 Piece", price: 90 }, { name: "Box of 4", price: 350 }] },
    { id: 117, name: "Premium Strawberry Pastry", category: "Pastries", desc: "Premium triangular strawberry pastry.", weight: "Options Available", price: 80, image: "assets/premium_strawberry_pastry_real.jpg", tags: ["Premium"], hasOptions: true, options: [{ name: "1 Piece", price: 80 }, { name: "Box of 4", price: 300 }] },
    { id: 118, name: "Premium Pineapple Pastry", category: "Pastries", desc: "Premium triangular pineapple pastry.", weight: "Options Available", price: 80, image: "assets/premium_pineapple_pastry_1789192824018.jpg", tags: ["Premium"], hasOptions: true, options: [{ name: "1 Piece", price: 80 }, { name: "Box of 4", price: 300 }] },
    { id: 119, name: "Premium Mango Pastry", category: "Pastries", desc: "Premium triangular mango pastry.", weight: "Options Available", price: 90, image: "assets/premium_mango_pastry_1789192836031.jpg", tags: ["Premium", "Seasonal"], hasOptions: true, options: [{ name: "1 Piece", price: 90 }, { name: "Box of 4", price: 400 }] },
    ...
    { id: 122, name: "Nutella Hazelnut Bento Cake", category: "Bento Cakes", desc: "Miniature bento cake with Nutella and roasted hazelnuts.", weight: "1 Piece", price: 450, image: "assets/bento_nutella_hazelnut_1789224043172.jpg", tags: ["Bento"] },
    { id: 123, name: "Black Forest Bento Cake", category: "Bento Cakes", desc: "Miniature classic Black Forest bento cake.", weight: "1 Piece", price: 350, image: "assets/bento_black_forest_1789224160233.jpg", tags: ["Bento"] },
    { id: 124, name: "Vanilla Whipped Cream Bento Cake", category: "Bento Cakes", desc: "Miniature vanilla bento cake with light whipped cream.", weight: "1 Piece", price: 300, image: "assets/bento_vanilla_whipped_cream.jpg", tags: ["Bento"] },
